...
INSERT INTO MODUL (ID, KUERZEL, bezeichnung, CREDITS, SEMESTER_ID,  ANGERECHNET, HAS_MSP, HAS_TESTAT,TESTAT_PASSED, VERSION) VALUES (50,'sepc','Softwareentwicklungsprozesse',3,7,false,false,false,false,0);
INSERT INTO MODUL (ID, KUERZEL, bezeichnung, CREDITS, SEMESTER_ID,  ANGERECHNET, HAS_MSP, HAS_TESTAT,TESTAT_PASSED, VERSION) VALUES (51,'apsi','Aplikationsicherheit',3,7,false,true,false,false,0);
INSERT INTO MODUL (ID, KUERZEL, bezeichnung, CREDITS, SEMESTER_ID,  ANGERECHNET, HAS_MSP, HAS_TESTAT,TESTAT_PASSED, VERSION) VALUES (52,'webfr','Webframeworks',3,7,false,true,false,false,0);		INSERT INTO NOTE (ID, VERSION, NOTE, MODUL_ID) VALUES (521,0,5.3,52); UPDATE MODUL SET MSP_ID = 52 where ID = 521;
INSERT INTO MODUL (ID, KUERZEL, bezeichnung, CREDITS, SEMESTER_ID,  ANGERECHNET, HAS_MSP, HAS_TESTAT,TESTAT_PASSED, VERSION) VALUES (53,'webec','Web Engineering ',3,7,false,true,false,false,0);
...
INSERT INTO MODUL (ID, KUERZEL, bezeichnung, CREDITS, SEMESTER_ID,  ANGERECHNET, HAS_MSP, HAS_TESTAT,TESTAT_PASSED, VERSION) VALUES (55,'webpr','Webprogramming',3,7,false,false,false,false,0);
INSERT INTO MODUL (ID, KUERZEL, bezeichnung, CREDITS, SEMESTER_ID,  ANGERECHNET, HAS_MSP, HAS_TESTAT,TESTAT_PASSED, VERSION) VALUES (56,'webcl','Webclients',3,7,false,false,false,false,0);		INSERT INTO NOTE (ID, VERSION, NOTE, MODUL_ID) VALUES (561,0,6,56); UPDATE MODUL SET MSP_ID = 56 where ID = 561;
INSERT INTO MODUL (ID, KUERZEL, bezeichnung, CREDITS, SEMESTER_ID,  ANGERECHNET, HAS_MSP, HAS_TESTAT,TESTAT_PASSED, VERSION) VALUES (57,'egi','Clean up your Grammer',2,7,false,false,false,false,0);		INSERT INTO NOTE (ID, VERSION, NOTE, MODUL_ID) VALUES (571,0,4.58,57); UPDATE MODUL SET MSP_ID = 57 where ID = 571;	INSERT INTO NOTE (ID, VERSION, NOTE, MODUL_ID) VALUES (572,0,4.5,57); UPDATE MODUL SET MSP_ID = 57 where ID = 572;



insert into note (id,version, gewichtung, note, modul_id) values ((select max(id)+1 id from note), 0, 0,0,(select id from modul where kuerzel = 'sepc'));
insert into note (id,version, gewichtung, note, modul_id) values ((select max(id)+1 id from note), 0, 0,0,(select id from modul where kuerzel = 'sepc'));
insert into note (id,version, gewichtung, note, modul_id) values ((select max(id)+1 id from note), 0, 0,0,(select id from modul where kuerzel = 'webec'));
insert into note (id,version, gewichtung, note, modul_id) values ((select max(id)+1 id from note), 0, 0,0,(select id from modul where kuerzel = 'apsi'));
insert into note (id,version, gewichtung, note, modul_id) values ((select max(id)+1 id from note), 0, 0,0,(select id from modul where kuerzel = 'webpr'));

update modul m
set anzahl_noten = (select count(*) from note n where n.modul_id = m.id group by m.id);
