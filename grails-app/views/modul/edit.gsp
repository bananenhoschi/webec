            ...
            <div class="card-body">
                <div class="card card-body">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col form-inline col-sm-5">
                                <label class="col-sm-4 col-form-label col-form-label">Bezeichnung:</label>
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col form-inline col-sm-5">
                                <label class="col-sm-4 col-form-label col-form-label">Dozent:</label>
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col form-inline col-sm-5">
                                <label class="col-sm-4 col-form-label col-form-label">Semester:</label>
                    ...
                    <g:if test="${modul.hasTestat}">
                        <div class="form-inline">
                            <div class="form-row">
                                <div class="col form-inline col-sm-5">
                                    <label class="col-sm-4 col-form-label col-form-label">
                            ...
                            <div class="form-check ">
                                <label for="testatPassed" class="form-check-label">
                                    <g:field type="checkbox" id="testatPassed" name="testatPassed"
                                             value="${modul.testatPassed}"
                                             class="form-check-input "
                                             readonly="readonly"/>
                                    Testat erfüllt
                                </label>
